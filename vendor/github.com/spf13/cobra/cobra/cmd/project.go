...
// findCmdDir checks if base of absPath is command dir and returns it or
// looks for existing command dir in absPath.
// If the command dir doesn't exist, empty, or cannot be found,
// it returns "command".
